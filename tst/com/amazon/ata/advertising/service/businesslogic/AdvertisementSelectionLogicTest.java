...
public class AdvertisementSelectionLogicTest {
    ...
    public void selectAdvertisement_oneAd_returnsAd() {
        ...
        targetingGroupList.add(new TargetingGroup(TARGETING_GROUP_ID, CONTENT1.getContentId(),
                1.0, new ArrayList<>()));
        targetingGroupList.add(new TargetingGroup(TARGETING_GROUP_ID, CONTENT2.getContentId(),
                1.0, new ArrayList<>()));
        targetingGroupList.add(new TargetingGroup(TARGETING_GROUP_ID, CONTENT3.getContentId(),
                1.0, new ArrayList<>()));

        when(targetingGroupDao.get(CONTENT1.getContentId())).thenReturn(targetingGroupList);
        GeneratedAdvertisement ad = adSelectionService.selectAdvertisement(CUSTOMER_ID, MARKETPLACE_ID);
    ...
    public void selectAdvertisement_multipleAds_returnsOneRandom() {
        ...
        when(targetingGroupDao.get(any(String.class))).thenReturn(targetingGroupList);
        when(contentDao.get(MARKETPLACE_ID)).thenReturn(contents);
